...
export class ReceiveDetailRepository extends BaseRepository<
  Model<ReceiveDetailAttributes>
> {
  constructor() {
    super(db.ReceiveDetail);
  }

  //region Find methods
  async findAll(req: Request): Promise<Model<ReceiveDetailAttributes>[]> {
  ...
  async findByID(
    req: Request,
    pkid: number,
  ): Promise<Model<ReceiveDetailAttributes> | null> {
    return await super.findByID(req, pkid);
  }

  async where(
    req: Request,
    criteria: WhereOptions<ReceiveDetailAttributes>,
    options?: FindOptions<ReceiveDetailAttributes>,
  ): Promise<Model<ReceiveDetailAttributes>[]> {
    return super.where(req, criteria, options);
  }

  async whereExisting(
    req: Request,
    criteria: Partial<ReceiveDetailAttributes>,
  ): Promise<boolean> {
  ...
  async create(
    req: Request,
    entity: CreationAttributes<Model<ReceiveDetailAttributes>>,
  ): Promise<Model<ReceiveDetailAttributes> | string> {
    return super.create(req, entity);
  }

  async bulkCreate(
    req: Request,
    entities: CreationAttributes<Model<ReceiveDetailAttributes>>[],
  ): Promise<Model<ReceiveDetailAttributes>[] | string> {
  ...
  async bulkUpdateWithTransaction(
    ...
    entities: {
      pkid: number;
      values: Partial<ReceiveDetailAttributes>;
    }[],
    transaction: Transaction,
  ): Promise<void> {
  ...
  async update(
    req: Request,
    pkid: number,
    entity: Partial<ReceiveDetailAttributes>,
  ): Promise<[number, Model<ReceiveDetailAttributes>[]]> {
