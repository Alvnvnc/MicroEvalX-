...
blocks = [
    ...
    [
        ["totalClasses", data[4].get("totalClasses", "")],
        ["externalDependencies", data[4].get("externalDependencies", "")],
        ["sam", f"{data[4].get('sam', 0):.10f}".replace('.', ',')]
    ],
    [
        ["totalClasses", data[5].get("totalClasses", "")],
        ["maxInheritanceDepth", data[5].get("maxInheritanceDepth", "")],
        ["sidc", f"{data[5].get('sidc', 0):.10f}".replace('.', ',')]
    ],
    [
    ...
    [
        ["totalLoc", data[7].get("totalLoc", "")],
        ["totalCyclomaticComplexity", data[7].get("totalCyclomaticComplexity", "")],
        ["totalHalsteadVolume", data[7].get("totalHalsteadVolume", "")],
        ["avgCommentDensity", data[7].get("avgCommentDensity", "")],
        ["avgMI", f"{data[7].get('avgMI', 0):.10f}".replace('.', ',')]
    ]
]
